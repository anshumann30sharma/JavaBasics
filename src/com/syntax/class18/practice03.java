...
*/
	...
	practice03(String label,double price,String category,boolean hasExpiration,int stock){
		this. label=label;
		this.price=price; 
...
practice03(String label,double price, int stock){
	this.label=label;
	this.price=price; 
	this.category="misc";
	this.  hasExpiration =hasExpiration;
...
practice03(String label,double price){
	this.label=label;
	this.price=price; 
	this.category="misc";
	this.  hasExpiration =hasExpiration;
...
public static void main(String[] args) {
	practice03 obj=new practice03("Eggs ",3.0 ,"Produce ",true ,10);
	obj.displayOutput();
	practice03 obj1=new practice03("Paper Towels",2.0,24);
	obj1.displayOutput();
	practice03 obj2=new practice03("Paper Towels", 2.0);
	obj2.displayOutput();
